...
class KGEModel(nn.Module):
    ...
    def forward(self, sample, flag=False, mode='single'):
        '''
...
#        print(relation, self.embedding_range.item(), relation.size(), phase_relation)
...
#        print(re_score, im_score, score)
    ...
    @staticmethod
    def test_step(model, test_triples, all_true_triples, args, flag):
        '''
