...
#        print(id2entity)
#        print(id2entity[8], id2entity[9], id2entity[99], id2entity[999])
    ...
    if args.do_train:
        ...
        for step in range(init_step, args.max_steps):
            ...
            if args.do_valid and step % args.valid_steps == 0:
                ...
                metrics = kge_model.test_step(kge_model, valid_triples, all_true_triples, args, False)
...
#        df.to_csv('output.csv')
    ...
    if args.evaluate_train:
        ...
        metrics = kge_model.test_step(kge_model, train_triples, all_true_triples, args, False)
        log_metrics('Test', step, metrics)
